...
export const pt: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Por favor execute npm install -g @homesoft/happy-coder@latest',
    ...
    machine: {
        ...
        offlineHelp: '• Verifique se seu computador está online\n• Execute `happy daemon status` para diagnosticar\n• Você está usando a versão mais recente do CLI? Atualize com `npm install -g @homesoft/happy-coder@latest`',
