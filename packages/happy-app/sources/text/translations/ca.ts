...
export const ca: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Si us plau executeu npm install -g @homesoft/happy-coder@latest',
