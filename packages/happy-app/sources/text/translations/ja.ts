...
export const ja: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'npm install -g @homesoft/happy-coder@latest を実行してください',
    ...
    machine: {
        ...
        offlineHelp: '• コンピューターがオンラインであることを確認してください\n• `happy daemon status`を実行して診断してください\n• 最新のCLIバージョンを使用していますか？`npm install -g @homesoft/happy-coder@latest`でアップグレードしてください',
        daemon: 'デーモン',
        status: 'ステータス',
        stopDaemon: 'デーモンを停止',
