...
export const es: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Por favor ejecute npm install -g @homesoft/happy-coder@latest',
